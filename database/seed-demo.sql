...
INSERT INTO `consorcio_usuarios` (`id`, `login`, `senha`, `nome`, `email`, `status`, `role`, `month_goal`)
VALUES
  (1, 'admin', '0192023a7bbd73250516f069df18b500', 'Carlos Silva', 'carlos@local.dev', 'ATIVO', 'ADMIN', 500000),
  (2, 'amanda', '0192023a7bbd73250516f069df18b500', 'Amanda Rodrigues', 'amanda@local.dev', 'ATIVO', 'VENDEDOR', 500000),
  (3, 'bruno', '0192023a7bbd73250516f069df18b500', 'Bruno Costa', 'bruno@local.dev', 'ATIVO', 'VENDEDOR', 500000)
ON DUPLICATE KEY UPDATE `nome` = VALUES(`nome`), `role` = VALUES(`role`), `month_goal` = VALUES(`month_goal`);
